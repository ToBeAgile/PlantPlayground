...
conf = prepareLEconf('1-000-111-1-000-0-0-0-11')

 
class ADS1115Runner(): #cmd.Cmd):
    intro = '''usage: type following commands
          1    - one-shot measurement mode, timed - in a loop
...
#    __logfile = None
    ...
    def i2c_reader_init(self, arg):
        ...
        #conf = prepareLEconf('1-110-001-1-000-0-0-0-11') # Works from example
        #conf = prepareLEconf('1-110-001-1-000-0-0-0-11')
        conf = prepareLEconf('1-000-111-1-000-0-0-0-11')        
    
    def i2c_read(self, arg):
    ...
    def do_1(self, arg):
        '''One-shot, differential read value from channel 0 with wait time'''
        resetChip()
